"""
Django settings for silent_smoke_43180 project.
...
ROOT_URLCONF = 'silent_smoke_43180.urls'
...
WSGI_APPLICATION = 'silent_smoke_43180.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_smoke_43180 API",
    "DESCRIPTION": "API documentation for silent_smoke_43180 App",
    "VERSION": "v1",
}
